...
curl "https://dlcdn.apache.org/sedona/1.4.1/apache-sedona-1.4.1-bin.tar.gz" -o resources/software/apache-sedona-1.4.1-bin.tar.gz
...
curl "https://dlcdn.apache.org/hbase/2.5.5/hbase-2.5.5-bin.tar.gz" -o resourcessoftware//hbase-2.5.5-bin.tar.gz