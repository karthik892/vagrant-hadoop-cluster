...
curl "https://dlcdn.apache.org/spark/spark-3.4.1/spark-3.4.1-bin-hadoop3.tgz" -o resources/software/spark-3.4.1-bin-hadoop.tgz
...
curl "https://dlcdn.apache.org/sedona/1.5.0/apache-sedona-1.5.0-bin.tar.gz" -o resources/software/apache-sedona-1.4.1-bin.tar.gz
